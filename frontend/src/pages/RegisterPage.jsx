    ...
    <div className="min-h-screen bg-[#06080d] bg-mesh flex items-center justify-center p-4 relative overflow-hidden text-slate-100 font-sans">
      ...
      <div className="w-full max-w-md glass-panel glass-panel-glow rounded-3xl p-8 animate-fade-in relative z-10">
        <div className="flex flex-col items-center mb-6">
          <div className="w-16 h-16 rounded-2xl bg-slate-950/80 border border-amber-500/30 flex items-center justify-center mb-3 shadow-md shadow-amber-500/10 shield-pulse">
        ...
        {error && (
          <div className="mb-5 p-3 rounded-xl bg-rose-500/10 border border-rose-500/25 flex items-center gap-3 text-rose-300 text-sm animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-slate-450 uppercase tracking-wider mb-1.5 font-display">
              Email
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950/80 border border-slate-850 hover:border-slate-800 focus:border-amber-500/80 focus:ring-1 focus:ring-amber-500/40 rounded-xl py-2.5 pl-11 pr-4 text-sm text-slate-100 placeholder-slate-700 transition-all font-sans"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950/80 border border-slate-850 hover:border-slate-800 focus:border-amber-500/80 focus:ring-1 focus:ring-amber-500/40 rounded-xl py-2.5 pl-11 pr-4 text-sm text-slate-100 placeholder-slate-700 transition-all font-mono"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950/80 border border-slate-850 hover:border-slate-800 focus:border-amber-500/80 focus:ring-1 focus:ring-amber-500/40 rounded-xl py-2.5 pl-11 pr-11 text-sm text-slate-100 placeholder-slate-700 transition-all font-mono"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-vault-gold to-amber-600 font-bold text-sm text-slate-950 shadow-md shadow-vault-gold/15 hover:brightness-110 active:scale-[0.99] transition-all flex items-center justify-center gap-2 mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
        ...
        <div className="mt-2 text-center text-xs text-cyan-400 font-mono">
          <button
            type="button"
            onClick={continueAsGuest}
            className="text-cyan-400 hover:text-cyan-300 font-mono text-xs transition-colors underline"
          >
